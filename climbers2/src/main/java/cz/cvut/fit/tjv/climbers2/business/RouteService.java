...
public class RouteService extends AbstractCrudService<Route, Long>
{
    ...
    @Override
    public Route create(Route route) throws EntityNotFoundException{
        Centre centre = route.getCentre();
        if(!centreRepository.existsById(centre.getId())) throw new EntityNotFoundException();
    ...
    public void deleteById(Long routeId){
        ...
        if(route.isEmpty()) throw new EntityNotFoundException();
