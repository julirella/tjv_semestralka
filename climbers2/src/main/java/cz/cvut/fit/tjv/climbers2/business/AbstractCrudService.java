...
public abstract class AbstractCrudService<Entity extends DomainEntity<ID>, ID> {
    ...
    public Entity readById(ID id){
        ...
        if(entity.isEmpty()) throw new IdDoesNotExistException("Requested entity with id " + id + " doesn't exist.");
        return entity.get();
    }
    ...
    public void deleteById(ID id) {
        if(!repository.existsById(id)) throw new IdDoesNotExistException("Requested entity with id " + id + " doesn't exist.");
